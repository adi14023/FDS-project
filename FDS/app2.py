...
def main(): 
    ...
    sym1  = st.selectbox("symptoms1",["Fever","loss in weight","loss of appetite","swollen","Dejection"])
    sym2  = st.selectbox("symptoms2",["Diarrhea","Difficulty in breathing","Respiratory distress","High moratality"])
    sym3  = st.selectbox("symptoms3",["Coughing","Vomiting","Respiratory distress","Seizuers","Dehydration"])
